...
const Modal = ({
    ...
    return show && createPortal((
        <div className="bg-black/50 backdrop-blur-xl p-4 absolute inset-0 flex justify-center items-center">
            <div className="max-w-[640px] bg-slate-800/50 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden border border-slate-700/50 ring-1 ring-slate-600/20">
                <div className="text-center text-slate-200 uppercase">
                    {title}
                </div>
